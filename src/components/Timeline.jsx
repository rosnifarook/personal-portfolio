        ...
        {data.map((item, index) => (
          ...
          >
            <div className="sticky z-40 flex flex-col items-center self-start max-w-xs md:flex-row top-40 lg:max-w-sm md:w-full">
              ...
              <div className="hidden flex-col gap-1 font-bold md:flex md:pl-20">
                <h3 className="text-4xl text-neutral-300">{item.title}</h3>
            ...
            <div className="relative w-full pl-20 pr-4 md:pl-4">
              <div className="mb-4 block text-left font-bold md:hidden">
                <h3 className="text-2xl text-neutral-300">{item.title}</h3>
                <h3 className="text-xl text-neutral-400">{item.job}</h3>
                <h3 className="text-sm text-neutral-500">{item.date}</h3>
              </div>
